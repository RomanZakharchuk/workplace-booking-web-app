...
type PropsType = {
    colorIconLock: string;
}

const IconLock: FC<PropsType> = ({ colorIconLock }) => {
    return (
        <div>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    stroke={colorIconLock} strokeWidth="1.5" strokeLinecap="round"
                    strokeLinejoin="round" />
                <path d="M11.9102 14.1562V16.3772" stroke={colorIconLock}
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round" />
                <path fillRule="evenodd" clipRule="evenodd"
                      ...
                      stroke={colorIconLock} strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round" />
            </svg>
        </div>
