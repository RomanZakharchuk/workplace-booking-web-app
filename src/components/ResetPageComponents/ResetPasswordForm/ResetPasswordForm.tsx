...
import { submitNewPassword } from "../../../modules/auth/store/auth.actions";
...
const ResetPasswordForm: FC<PropsType> = ({ hideForm, token }) => {
    ...
    const submit: SubmitHandler<InputType> = (data) => {
        ...
        dispatch(submitNewPassword.request({ password: repeatPassword, token, callback }));
        hideForm();
        reset();
    };
